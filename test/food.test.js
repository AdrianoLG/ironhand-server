...
describe('Food CRUD', function() {
	...
	it('should create a food product', function(done) {
		api
			...
			.field('img', 'http://dev.ironhand-images.net/food/pimientos-de-piquillo.jpg')
			.field('qty', 250)
			.field('unit', 'gramos')
			.field('productQty', 2)
			...
			.end((err, res) => {
				...
				expect(res.body.createdProduct.img).to.equal('http://dev.ironhand-images.net/food/pimientos-de-piquillo.jpg')
